...
potatoes look right here, the exact same numpy frame is what the detector gets.
...
Run inside the potato_test env. cv2's Qt plugin needs libSM/libICE, which live in the
