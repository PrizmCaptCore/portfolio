...
The remap itself is the easy part: source class 3 ('Potato') is the healthy one, so it
...
SRC = os.path.join(REPO, "potato_extern_dataset", "potato_downloads",
                   "Potato_detection.v11i.yolov11")
DST = os.path.join(REPO, "datasets", "potato_binary_nanodet")

# data.yaml order: ['Damaged potato', 'Defected potato', 'Diseased-fungal potato',
#                   'Potato', 'Sprouted potato']
NORMAL_ID = 3
