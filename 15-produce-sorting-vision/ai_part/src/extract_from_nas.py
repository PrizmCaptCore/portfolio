...
footprint rather than keeping whatever happened to be around.
    ...
    python extract_from_nas.py --nas potato_videos_2   # another NAS folder -> labeling_all_2/
...
from detect_potato import Detector, DEF_CFG, DEF_DET, REPO
...
DEFAULT_NAS = os.environ.get("NAS_FOLDER", "potato_videos")
...
def main():
    ...
    p.add_argument("--nas", default=DEFAULT_NAS,
                   help="folder under pre_project on the NAS (potato_videos_0831, _2, _3)")
    p.add_argument("--out", default=None,
                   help="output root; default labeling_all plus the folder's suffix, "
                        "so potato_videos_0831_2 -> labeling_all_2")
