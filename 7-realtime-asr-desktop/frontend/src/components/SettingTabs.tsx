...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">전사</TabsTrigger>
    <TabsTrigger value="modelSettings">AI 요약</TabsTrigger>
    <TabsTrigger value="recordingSettings">환경설정</TabsTrigger>
