    ...
    <div className={`bg-white border border-gray-200 rounded-lg p-4 ${className}`}>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-gray-700">
            청크 {progress.completed_chunks}/{progress.total_chunks}개 완료
          </span>
          <span className="text-sm font-medium text-gray-700">
      ...
      <div className="space-y-2">
        <h4 className="text-sm font-medium text-gray-700 mb-2">
          최근 청크 ({Math.min(progress.chunks.length, 10)}/{progress.total_chunks})
        </h4>
        ...
        <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-3">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-green-800">
              처리가 완료되었습니다! 청크 {progress.total_chunks}개가 모두 전사되었습니다.
            </span>
          </div>
        </div>
      )}
  ...
  return (
    <div className={`bg-gray-50 border border-gray-200 rounded-lg p-3 ${className}`}>
      ...
      <div className="text-xs text-gray-600">
        청크 {progress.completed_chunks} / {progress.total_chunks}
