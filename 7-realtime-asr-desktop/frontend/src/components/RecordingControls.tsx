                          ...
                          >
                            ...
                            {(isPausing || isResuming) && (
                              <div className="absolute -top-8 text-gray-600 font-medium text-xs">
                                {isPausing ? '일시정지 중…' : '재개 중…'}
                              </div>
                            )}
                          </button>
                        </TooltipTrigger>
                        <TooltipContent>
                          <p>{isPaused ? '녹음 재개' : '녹음 일시정지'}</p>
                        </TooltipContent>
                      </Tooltip>
