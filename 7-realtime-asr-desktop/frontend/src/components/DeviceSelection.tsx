  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-gray-500 space-y-1">
        <p>• <strong>마이크:</strong> 음성과 주변 소리를 녹음합니다</p>
        <p>• <strong>시스템 오디오:</strong> 음악·통화 등 컴퓨터에서 재생되는 소리를 녹음합니다</p>
        {isMonitoring && (
          <p>• <strong>마이크 레벨:</strong> 초록 = 적정, 노랑 = 큰 편, 빨강 = 너무 큼</p>
        )}
        {!isMonitoring && inputDevices.length > 0 && (
          <p>• <strong>팁:</strong> "마이크 테스트"를 눌러 마이크 동작을 확인할 수 있습니다</p>
        )}
      </div>
    </div>
  );
