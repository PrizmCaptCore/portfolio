        ...
        return (
          ...
          >
            <div className="flex items-start gap-2">
              <Tooltip>
                <TooltipTrigger>
                  <div className="mt-1 flex-shrink-0 min-w-[50px] text-right">
                    ...
                    {transcript.source && (
                      <span className={`block text-[10px] font-medium ${
                        transcript.source === 'Me' ? 'text-blue-500' : 'text-emerald-500'
                      }`}>
                        {transcript.source === 'Me' ? '나' : '상대'}
                      </span>
                    )}
                  </div>
                </TooltipTrigger>
      ...
      {transcripts.length === 0 && (
        ...
        >
          {isRecording ? (
            ...
            <>
              <p className="text-lg font-semibold">Relay Assistant에 오신 걸 환영합니다!</p>
