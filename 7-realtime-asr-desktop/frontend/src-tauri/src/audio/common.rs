...
/// No-op: cloud-based transcription providers have no local model to unload.
pub(crate) async fn unload_engine_after_batch(_use_cnn_stt: bool) {
    log::info!("Skipping model unload: using cloud-based transcription provider");
}
