    ...
    async fn create_core_audio_stream(
        ...
        let task = tokio::spawn({
            ...
            async move {
                ...
                info!(
                    " Stream: Core Audio processing task ended for {}",
                    device_name
                );
            }
        });
...
impl AudioStreamManager {
    ...
    pub async fn start_streams(
        ...
        if let Some(mic_device) = microphone_device {
            ...
            info!("ℹ No microphone device specified, skipping microphone stream");
        }
        ...
        if let Some(sys_device) = system_device {
            ...
            info!("ℹ No system device specified, skipping system audio stream");
        }
