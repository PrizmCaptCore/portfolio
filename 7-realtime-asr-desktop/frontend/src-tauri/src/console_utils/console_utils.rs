        ...
        match Command::new("osascript")
            ...
            .arg(
                ...
                tell application "Terminal"
                    activate
                    do script "log stream --process relay-assistant --level info --style compact"
                end tell
            "#,
            )
            .spawn()
            ...
            .arg(r#"
                tell application "Terminal"
                    ...
                    repeat with aWindow in windowList
                        if contents of selected tab of aWindow contains "log stream --process relay-assistant" then
                            close aWindow
                        end if
                    end repeat
                end tell
