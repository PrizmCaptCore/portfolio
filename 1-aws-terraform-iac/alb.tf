...
# Distributes traffic to application servers in service VPC
...
resource "aws_lb" "main" {
  ...
  subnets            = aws_subnet.service_public[*].id
...
# Route /admin/* with authentication
...
output "route53_record" {
  description = "Route53 record for ALB"
