"""Re-lay out datasets/item for NanoDet's YoloDataset.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default=os.path.join(REPO, "datasets", "item"))
    parser.add_argument("--dst", default=os.path.join(REPO, "datasets", "item_nanodet"))
