...
The web-photo-trained 1-class detector boxes empty cup-carrier wheel pockets as items: wide
~2:1 boxes at confidence 0.50-0.65. Real items are ~1:1, and the few genuinely elongated
items score >= 0.70, so the rule is
